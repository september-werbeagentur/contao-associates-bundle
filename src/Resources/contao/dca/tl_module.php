...
$GLOBALS['TL_DCA']['tl_module']['palettes']['associateslist'] = '{title_legend},name,type;{swa_result_legend},swa_noResult;{redirect_legend},jumpTo;{protected_legend:hide},protected;{swa_distance_matrix_legend},distance_matrix_key;{expert_legend:hide},guests,cssID;';
